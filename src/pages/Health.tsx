    ...
    <div className="v2-page-container">
      <div className="v2-inner-container">
        ...
        <div className="v2-stats-grid">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="v2-stat-value text-slate-900 flex items-center gap-2">
                    ...
                    <Badge className="bg-emerald-100 text-emerald-700 border-none text-[10px] py-0 px-2">
                      优秀
                    </Badge>
                  </div>
                </div>
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  <SelectContent className="bg-white border-slate-200 shadow-xl rounded-xl">
                    <SelectItem
                      value="绿色店铺"
                      className="text-xs font-bold text-emerald-600 focus:bg-emerald-50"
                    >
                      绿色店铺
                    </SelectItem>
                    <SelectItem
                      value="领导者店铺"
                      className="text-xs font-bold text-sky-600 focus:bg-sky-50"
                    >
                      领导者店铺
                    </SelectItem>
                    <SelectItem
                      value="白银店铺"
                      className="text-xs font-bold text-slate-400 focus:bg-slate-50"
                    >
                      白银店铺
                    </SelectItem>
                    <SelectItem
                      value="黄金店铺"
                      className="text-xs font-bold text-amber-500 focus:bg-amber-50"
                    >
                      黄金店铺
                    </SelectItem>
                    <SelectItem
                      value="铂金店铺"
                      className="text-xs font-bold text-indigo-600 focus:bg-indigo-50"
                    >
                      铂金店铺
                    </SelectItem>
                    <SelectItem
          ...
          <div className="v2-stat-card bg-white border-rose-200/60 shadow-lg">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-2xl bg-rose-50 flex items-center justify-center">
                <AlertTriangle className="w-7 h-7 text-rose-500" />
              </div>
              <div>
                <span className="v2-stat-label text-rose-600 font-bold">
                  待处理纠纷
                </span>
                ...
                {claims.length > 0 ? (
                  claims.map((claim) => (
                    <tr key={claim.id} className="v2-table-tr group">
                      <td className="v2-table-td text-sky-600 font-mono font-bold tracking-tight">
                        {claim.orderId}
                      </td>
                      <td
                        className="v2-table-td text-slate-600 max-w-[200px] truncate font-medium"
                        title={claim.productName}
                      >
                        {claim.productName}
                      </td>
                      <td className="v2-table-td">
                        <span className="text-rose-600 font-bold bg-rose-50 px-2 py-0.5 rounded border border-rose-100 text-[10px]">
                          {claim.request}
                        </span>
                      </td>
                      <td className="v2-table-td">
